				...
				<div class="panel-body">
					...
					if (isset($_POST['btn_publish'])) {
						...
						if (empty($file_name_gambar)) {
							$pesan[] = "<b>Anda Belum Memilih File Untuk gambar</b>";
						} else {
						...
						if (!count($pesan) == 0) {
							$num = 0;
							foreach ($pesan as $index => $show_message) {
								$num++;
					?>
								...
								<div class="col-sm-4">
									...
									<div class="form-group">
										...
										<select class="form-control input-sm" name="kategori">
											...
											<?php while ($kat = $qry_kategori->fetch_assoc()) { ?>
									...
									<div class="form-group">
										...
										<center><img id="image" width="100%" height="250" alt="Preview Gambar"></center>
									</div>
								</div>
								<div class="col-sm-12">

...
$kategori_sql = "SELECT kategori FROM kategori WHERE id_kategori='" . $mysqli->real_escape_string($kode) . "'";

$kategori_qry = $mysqli->query($kategori_sql);

$kategori = $kategori_qry->fetch_assoc();
		...
		<div class="col-lg-10 main-content">
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="row">
						<div class="col-md-12">
							<h2 class="page-header"><i class="fa fa-folder-o"></i> Hapus Kategori: <strong><?php echo $kategori['kategori']; ?></strong></h2>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
